...
public class ListGeneralCommunicationEventsFault
    extends Exception
{
     ...
     * @param message
     */
    public ListGeneralCommunicationEventsFault(String message, DSFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public ListGeneralCommunicationEventsFault(String message, DSFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
