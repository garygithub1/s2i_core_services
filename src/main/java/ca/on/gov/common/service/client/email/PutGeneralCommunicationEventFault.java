...
public class PutGeneralCommunicationEventFault
    extends Exception
{
     ...
     * @param message
     */
    public PutGeneralCommunicationEventFault(String message, DSFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public PutGeneralCommunicationEventFault(String message, DSFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
