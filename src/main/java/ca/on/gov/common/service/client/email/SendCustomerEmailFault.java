...
public class SendCustomerEmailFault
    extends Exception
{
     ...
     * @param message
     */
    public SendCustomerEmailFault(String message, DSFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public SendCustomerEmailFault(String message, DSFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
